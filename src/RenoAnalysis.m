...
title('Reno flow 1 instantaneous throughput');
figure
plot(time, flow2)
xlabel('Time(s)')
ylabel('Throughput(Mbps)')
title('Reno flow 2 instantaneous throughput');
figure
plot(time, flow3)
xlabel('Time(s)')
ylabel('Throughput(Mbps)')
title('Reno flow 3 instantaneous throughput');
figure
plot(time, flow4)
xlabel('Time(s)')
ylabel('Throughput(Mbps)')
title('Reno flow 4 instantaneous throughput');
