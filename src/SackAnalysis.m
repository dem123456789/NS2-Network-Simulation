...
title('Sack flow 1 instantaneous throughput');
figure
plot(time, flow2)
xlabel('Time(s)')
ylabel('Throughput(Mbps)')
title('Sack flow 2 instantaneous throughput');
figure
plot(time, flow3)
xlabel('Time(s)')
ylabel('Throughput(Mbps)')
title('Sack flow 3 instantaneous throughput');
figure
plot(time, flow4)
xlabel('Time(s)')
ylabel('Throughput(Mbps)')
title('Sack flow 4 instantaneous throughput');
